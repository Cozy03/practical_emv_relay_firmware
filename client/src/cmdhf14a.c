...
static int CmdHF14ATFL(const char *Cmd) {
    CLIParserContext *ctx;
    CLIParserInit(&ctx, "hf 14a tfl",
                  "Act as a ISO-14443a TfL reader to identify tag. Look for ISO-14443a tags until Enter or the pm3 button is pressed",
                  "hf 14a reader -@   -> Continuous mode");
    ...
    do {
        clearCommandBuffer();
        SendCommandMIX(CMD_HF_ISO14443A_TFL, cm, 0, 0, NULL, 0);
...
static command_t CommandTable[] = {
    ...
    {"tfl",         CmdHF14ATFL,          IfPm3Iso14443a,  "Act like a TfL ISO14443-a reader"},
